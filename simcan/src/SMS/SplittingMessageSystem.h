...
class SplittingMessageSystem{
	...
	protected:
		...
		/** Requests vector */
		vector <SIMCAN_Request*> requestVector;		
	...
	public:		
	   ...
	   /**
		* Search for the SIMCAN_Request that contains the <b>request</b> message
	   ...
	   /**
		* Gets the number of subRequest of the SIMCAN_Request that contains the <b>request</b> message
	   ...
	   /**
		* Adds a new SIMCAN_Request that contains the <b>request</b> message.
	   ...
	   /**
		* Removes the SIMCAN_Request that contains the <b>request</b> message
		...
		*/
		SIMCAN_Message* popSubRequest (cMessage* parentRequest, int subRequestIndex);
		...
		* @return Corresponding subRequest or NULL if parent request not found.
		*/
		SIMCAN_Message* popNextSubRequest (cMessage* parentRequest);
