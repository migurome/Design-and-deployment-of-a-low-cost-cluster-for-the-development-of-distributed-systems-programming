#ifndef __DISK_400GB_LI_H_
#define __DISK_400GB_LI_H_
...
/**
 * @class Disk_400GB_LI Disk_400GB_LI.h "Disk_400GB_LI.h"
 *
 ...
 * @date 2009-03-11
 */
class Disk_400GB_LI: public cSIMCAN_Base{
	...
	private:
		...
		*/
		simtime_t diskTime (off_blockList_t offsetBlock, size_blockList_t brachSize, char operation);
...
int64 Disk_400GB_LI::blockSizes [19] = {512, 1024 , 2048 , 4096 , 8192 , 16384 , 32768 , 65536 , 131072 , 262144 , 524288 , 1048576 , 2097152 , 4194304 , 8388608 , 16777216 , 33554432 , 67108864 , 134217728 };
int64 Disk_400GB_LI::jumpsSizes [9] = {0, 512 , 1024 , 4096 , 32768 , 131072 , 1048576 , 10485760 , 104857600 };


const const_simtime_t Disk_400GB_LI::readTimes [19] [9] = {
...
const const_simtime_t Disk_400GB_LI::writeTimes [19] [9] = {
