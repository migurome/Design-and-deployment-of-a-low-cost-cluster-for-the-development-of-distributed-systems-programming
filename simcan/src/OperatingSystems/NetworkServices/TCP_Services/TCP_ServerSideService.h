...
class TCP_ServerSideService: public TCPSocket::CallbackInterface{	
	...
	*/
	struct SIMCAN_TCP_Server_Connector{
		int port;
		int appIndex;
	};
	typedef struct SIMCAN_TCP_Server_Connector serverTCP_Connector;		
	...
	protected:
	    ...
	    /** Output gate to TCP */
	    cGate* outGate_ServiceRedirector;
	...
	public:
		 ...
		 */
		void newListenConnection (SIMCAN_Message *sm_net);
	     ...
	     */
	    void sendPacketToClient(SIMCAN_Message *sm);
