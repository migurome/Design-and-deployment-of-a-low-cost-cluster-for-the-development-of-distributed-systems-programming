...
\begin{quote}
\textit{"Tenemos que fabricar máquinas que nos permitan seguir fabricando máquinas, porque lo que no va a hacer nunca la máquina es fabricar máquinas"}
M.Rajoy
\end{quote}
...
1 sudo apt-get install pollas
2 sudo apt-get update
\end{lstlisting}

\begin{lstlisting}[frame=single][language=c][numbers=left][stepnumber=1]  % Start your code-block
...
5 sudo nano /etc/default/isc-dchp-server
INTERFACES = “eth0”
\end{lstlisting}
