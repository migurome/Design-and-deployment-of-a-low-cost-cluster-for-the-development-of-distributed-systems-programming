...
\section{Componentes}
\subsection{Antecedentes biológicos}
...
\subsection{Prototipo A}
\subsection{Prototipo B}
\subsection{Prototipo C}
...
\subsection{Evaluacion de prototipos}
...
\subsection{Mejoras en el algoritmo evolutivo}
...
\end{itemize}
\subsection{Métodos de inicialización}
...
\end{enumerate}
\subsubsection{Función de evaluación -Fitness-}
...
\subsection{Mejoras en el algoritmo evolutivo}
\subsubsection{Control del bloating}
